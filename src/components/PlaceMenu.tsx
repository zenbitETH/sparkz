...
const validateLocation = async (locationName: string, latitude: string, longitude: string) => {
  const { proof, publicSignals } = await snarkjs.groth16.fullProve(
    ...
    , "/LocationProof.wasm", "/LocationProof_0001.zkey");
  ...
  return (
   ...
   <div className="text-black bg-purple-200 absolute top-80 right-30 border border-purple-500 p-10 rounded-full text-lg z-100">
      {message}
    </div>}
    </>
