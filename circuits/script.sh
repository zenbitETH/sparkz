...
circom LocationProof.circom --r1cs --wasm --sym --c
...
node generate_witness.js LocationProof.wasm ../input.json witness.wtns
...
snarkjs groth16 setup LocationProof.r1cs pot12_final.ptau LocationProof_0000.zkey

echo "-------Making the contribution tau ceremony Phase-2-----\n\n"
snarkjs zkey contribute LocationProof_0000.zkey LocationProof_0001.zkey --name="1st Contributor Name" -v -e="kira"
snarkjs zkey export verificationkey LocationProof_0001.zkey verification_key.json

cp LocationProof_js/witness.wtns .
